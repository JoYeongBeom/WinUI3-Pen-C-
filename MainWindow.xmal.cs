...
namespace PenApp
{
    public sealed partial class MainWindow : Window
    {
        ...
        private void myWrite_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                using (StreamWriter sw = new StreamWriter("D:\\VisualPrograming\\my.txt"))
                {
        ...
        private void myRead_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                using (StreamReader sr = new StreamReader("D:\\VisualPrograming\\my.txt"))
                {
                    vx.Clear();
                    vy.Clear();
                    col.Clear();
        ...
        private void MenuFlyoutItem_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                using (StreamWriter sw = new StreamWriter("D:\\VisualPrograming/1.txt"))
                {
                    for (int i = 0; i < vx.Count; i++)
                    {
        ...
        private void MenuFlyoutItem_Click_2(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                using (StreamReader sr = new StreamReader("D:\\VisualPrograming/1.txt"))
                {
                    vx.Clear();
                    vy.Clear();
                    size.Clear();
